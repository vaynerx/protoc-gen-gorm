...
var unneededImports = []string{
	...
	"import _ \"github.com/vaynerx/protoc-gen-gorm/options\"\n",
	// if needed will be imported with an alias
	"import _ \"github.com/vaynerx/protoc-gen-gorm/types\"\n",
	"var _ = proto.Marshal\n",
}
...
var (
	...
	gtypesImport       = "github.com/vaynerx/protoc-gen-gorm/types"
	...
	gerrorsImport      = "github.com/vaynerx/protoc-gen-gorm/errors"
	stdFmtImport       = "fmt"
